        ...
        <div class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
            <div class="lg:flex lg:items-center">
                ...
                <div class="flex flex-col text-gray-600 capitalize dark:text-gray-300 lg:flex lg:px-16 lg:-mx-4 lg:flex-row lg:items-center">
                    <a href="#" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 border-b-2 border-transparent hover:border-red-500">features</a>
                    <a href="#" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 border-b-2 border-transparent hover:border-red-500"">downloads</a>
                    <a href="#" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 border-b-2 border-transparent hover:border-red-500"">docs</a>
                    <a href="#" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 border-b-2 border-transparent hover:border-red-500"">support</a>
                    <a href="#" class="mt-2 lg:mt-0 lg:mx-4 hover:text-gray-800 dark:hover:text-gray-200 border-b-2 border-transparent hover:border-red-500"">blog</a>
    ...
    <div class='flex w-full mt-2 max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800'>
        ...
        <div class='px-4 py-2 -mx-3'>
            <div class='mx-3'>
                ...
                <p class='text-sm text-gray-600 dark:text-gray-200'>Please Fill all the Fields!</p>
            </div>
        </div>
    </div>";
    }
...
?>
              ...
              <div class="mt-4">
                ...
                <input name="occupation" value="Student" type="radio" />
                <label class="text-sm">Student</label>
                </br>
                <input name="occupation" value="Parent" type="radio" />
