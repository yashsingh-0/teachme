            ...
            <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    <li class="mr-3 flex-1">
                        <a href="./admin-panel-teachers.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 border-pink-500">
                            <i class="fas fa-tasks pr-0 md:pr-3 text-pink-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Teachers</span>
                        </a>
                    </li>
                    <li class="mr-3 flex-1">
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="bg-gray-800 pt-3">
                <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                    <h3 class="font-bold pl-2">Teachers</h3>
                    <h3 class="font-bold pl-2">
					<p align="right"><a href="./admin-teachers-signup.php" class="inline-block py-2 px-3 text-white no-underline">Add Teachers</a></p>
					</h3>
                </div>
            </div>
<div class="flex flex-wrap">
            <?php 
                if(isset($_GET['teacher_signup'])) {
                    if($_GET['teacher_signup'] == "success") {
                        echo "
    <div class='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800'>
        ...
        <div class='px-4 py-2 -mx-3'>
            <div class='mx-3'>
                ...
                <p class='text-sm text-gray-600 dark:text-gray-200'>Teacher's account was registered!</p>
            </div>
        </div>
    </div>
        ";
	...
	<td class='flex inline-flex items-center'>
			        	...
			        	<span class='py-3 w-40'>
			        		 ...
			        		 <p class='md:hidden text-xs text-gray-600 font-medium'>244224317</p>
			          		 <p class='hidden md:table-cell text-xs text-gray-500 font-medium'>$array[subject]</p>
			        	</span>
			        </td>
